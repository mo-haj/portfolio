...
<div class="profile-details">
                <div class="profile-info text-center">
                    ...
                    <img id="preview" src="{{ Storage::url( $patient->Img) }}" alt="Doctor Profile Picture">
    <input type="file" id="img" name="img" onchange="previewImage()">
                       
                    </div>
                    <!-- Doctor Name -->
                    <div class="form-group">
                        <input type="text" class="form-control" readonly id="id" name="id"  value="{{$patient->id}}" style="width:40px;float:left;margin-right:5px;"  placeholder="ID Name">
                        <input type="text" class="form-control" id="name" name="name"  value="{{$patient->name}}"  required placeholder="Patient Name">
                    </div>  
                </div>
                ...
                <div class="doctor-info row">
                    <div class="col-4">
                    <div class="form-group">
                        <input type="email" class="form-control" id="email"  name="email"  value="{{$patient->email}}" required placeholder="email" style="width: 100%;">
                    </div>
                    
                    </div>
                    <div class="col-4">
                    <div class="form-group">
                        <input type="tel" class="form-control" id="number" name="number"  value="{{$patient->number}}" required placeholder="number" style="width: 100%;">
                        
                    </div>
                    </div>
                    <div class="col-4">
                    <div class="form-group">
                        <input type="text" class="form-control" id="disc" name="disc"  value="{{$patient->disc}}" required placeholder="Note" style="width: 100%;">
                    </div>
                    </div>
            ...
            <center>
            <button type="submit" class="btn col-md-1 col-sm-3 new-appointment-btn" style="margin-top:30px;">Edit</button>
            </center>
        </form>
    </div>
